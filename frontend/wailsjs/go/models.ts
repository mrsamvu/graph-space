export namespace main {
	...
	export class BugReportAttachment {
	    path: string;
	    name: string;
	    size: number;
	    contentType: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new BugReportAttachment(source);
	    }
	...
	export class BugReportRequest {
	    ...
	    static createFrom(source: any = {}) {
	        return new BugReportRequest(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.attachments = this.convertValues(source["attachments"], BugReportAttachment);
	    }
